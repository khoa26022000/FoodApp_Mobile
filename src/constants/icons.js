...
export const drink = require('../assets/icons/nuoc.png');
export const fire = require('../assets/icons/fire.png');
export const fries = require('../assets/icons/anvat.png');
export const hamburger = require('../assets/icons/hamburger.png');
export const hotdog = require('../assets/icons/banhmi.png');
...
export const noodle = require('../assets/icons/mi.png');
